// This file creates the database model for the dummyPerson service.
...
/* creates a new interface called IPerson that inherits from the Document class. The IPerson interface
   adds three additional properties(id, name, and age).
 */
...
/* creates a new PersonSchema from the Schema class and specifies the structure that the data in the mongodb collection
   will have. Documents made with this Schema will have an id, name and age properties. Documents created with this
